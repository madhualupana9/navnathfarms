...
$phone = $_POST['candidate_mobile'];
$message = $_POST['candidate_message'];
$resume = $_FILES['candidate_resume'];
if (isset($resume)) {
    $errors = array();
...
<body style="background-color:#00a0e3;">
                    ...
                    <td width="100%" style="min-width:100%;color:#FFFFFF;padding:5px;"></td>
                        <tr>
                            <td style="background-color:#F6F5FF;color:#333333;padding:30px;">
                                ...
                                <p style="font-family: Arial,sans-serif; ">Please find the below user details and attached resume.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:20px;background-color:#F6F5FF;">
                                <table width="100%" cellpadding="0" cellspacing="0" style="color:#333333">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th valign="top" style="padding:5px; width: 250px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;padding-bottom: 10px;">Message</th>
                                            <td valign="top" style="padding:5px; width: 250px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;padding-bottom: 10px;">' . $message . '</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
    ...
    try {
        ...
        $mail->addAddress('tulasi@infinityspark.in'); // Name is optional
